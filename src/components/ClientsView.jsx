  ...
  return (
    <div className="products-layout">
      <div className="product-form-card">
        ...
        <form
          onSubmit={(e) => handleAddClient(e, false)}
        ...
        >
          ...
          >
            <PlusCircle size={18} />{" "}
            {loadingClient ? "Guardando..." : "Guardar Cliente"}
          </button>
        </form>
      </div>
          ...
          <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
            <button
              ...
              style={{
                ...
                background: clientFilterTab === "all" ? "#1c7ed6" : "#fff",
                color: clientFilterTab === "all" ? "#fff" : "#495057",
                fontSize: "12px",
                cursor: "pointer",
                fontWeight: "bold",
              }}
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "4px",
                border: "1px solid #ced4da",
                background: clientFilterTab === "best" ? "#2b8a3e" : "#fff",
                color: clientFilterTab === "best" ? "#fff" : "#495057",
                fontSize: "12px",
                cursor: "pointer",
                fontWeight: "bold",
              }}
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "4px",
                border: "1px solid #ced4da",
                background: clientFilterTab === "debtors" ? "#fa5252" : "#fff",
                color: clientFilterTab === "debtors" ? "#fff" : "#495057",
                fontSize: "12px",
                cursor: "pointer",
                fontWeight: "bold",
              }}
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "4px",
                border: "1px solid #ced4da",
                background: clientFilterTab === "frequent" ? "#ae3ec9" : "#fff",
                color: clientFilterTab === "frequent" ? "#fff" : "#495057",
                fontSize: "12px",
                cursor: "pointer",
                fontWeight: "bold",
              }}
              ...
              {getFilteredClientsByTab().length === 0 ? (
                ...
                getFilteredClientsByTab().map((cli) => (
                  <tr
                    ...
                    title="Haz clic para ver historial y notas"
                  >
                    <td>
                    ...
                    <td>
                      <strong>${cli.totalBilled.toFixed(2)}</strong>
                    </td>
                    <td>
                      {cli.totalPending > 0 ? (
                        <span style={{ color: "#fa5252", fontWeight: "bold" }}>
                          ${cli.totalPending.toFixed(2)}
                        </span>
                      ) : (
